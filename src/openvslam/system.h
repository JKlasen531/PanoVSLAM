...
public:
    //! Constructor
    system(const std::shared_ptr<config>& cfg, const std::string& vocab_file_path, const std::string& project_folder_path);
    ...
    const std::shared_ptr<publish::image_publisher> get_image_publisher() const;
...
private:
    ...
    std::string project_folder_path_;
    ...
    data::image_database* img_db_ = nullptr;
    ...
    std::shared_ptr<publish::image_publisher> image_publisher_ = nullptr;
